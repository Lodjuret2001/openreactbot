...
const ActionProvider = ({ children, createChatBotMessage, setState, state, }) => {
    const handleSend = (message) => {
        ...
        async function handleChatBot() {
            ...
            const aiResponseMessage = createOpenAiTypeMessage(response.choices[0].message);
    ...
    const handleEmptyString = () => {
        const sorryMessage = createChatBotMessage("Sorry I didnt understand that!", { loading: true });
        setState((prev) => {
            return {
                ...prev,
